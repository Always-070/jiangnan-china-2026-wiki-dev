...
export function MolecularLoader({ routeKey }: MolecularLoaderProps) {
  ...
  useEffect(() => {
    ...
    timeline
      ...
      .to(shell.querySelector(".molecular-loader-node"), { scale: 1.18, duration: 0.18, yoyo: true, repeat: 1 }, 0.24)
  ...
  return (
    <div
      ...
      aria-hidden={!visible}
    >
      <svg viewBox="0 0 260 120" role="img" aria-label="Steroid scaffold loading animation">
        <path className="molecular-loader-line" d="M35 60 L62 36 L96 48 L103 82 L70 94 Z" />
        <path className="molecular-loader-line" d="M96 48 L130 35 L163 52 L156 87 L103 82 Z" />
        <path className="molecular-loader-line" d="M163 52 L196 40 L222 62 L207 94 L156 87 Z" />
